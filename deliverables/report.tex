...
\item \textbf{Feature engineering.}
  ...
  \begin{itemize}
    ...
    \item Volatility (5): rolling standard deviation of returns at horizons 50 and 100, price range, absolute velocity, inter-event time $\Delta t$ and $\log \Delta t$.
    ...
    \item Hawkes memory and OFI (44): Fabre-Challet limit and market order flows with EWMA at short (halflife\,$=$\,5) and long (halflife\,$=$\,50) horizons, deep-order insertions at level~5, weighted flows with spatial decay ($\eta \in \{0.001, 0.1, 1, 10\}$) and temporal decay ($\beta \in \{10, 100, 1000\}$), and five-level order flow imbalance.
  \end{itemize}
